@MetroE_CS_Portal_Aut_Subscription_flow
Feature: 0.1 Customer - New Subscription Flow

  @Customer_Auto_E2E_Flow_ATA
  Scenario Outline: Sceanrio "<Sceanrio ID>" I as a customer verify the New Subscription flow for Metro E Product Offerings "<Product_Offering>" through customer portal
    ...
    And I click quote by key in contract_duration as "<Contract_duration>" for CSPortal
    ...
    Examples: 
      ...
      #| UAT_E2E_MetroE_TC1.9  | regspweekk37@gmail.com | Standard MetroE ATA Fixed Rate                         | SG Connectivity | Network_ATA_GPON_Fixed           |             542116 | 24 Months         |
     # | UAT_E2E_MetroE_TC1.xx | regspweekk37@gmail.com | Standard MetroE ATA Burstable Rate                     | SG Connectivity | Network_ATA_GPON_Burst           |             542117 | 24 Months         |
     # | UAT_E2E_MetroE_TC1.10 | regspweekk37@gmail.com | Standard MetroE ATA Burstable Rate with Protected Path | SG Connectivity | Network_ATA_GPON_Burst_Protected |             542119 | 24 Months         |
     # | AT_E2E_MetroE_TC1.xx  | regspweekk37@gmail.com | Standard MetroE ATA Fixed Rate with Protected Path     | SG Connectivity | Network_ATA_GPON_Fixed_Protected |             542120 | 24 Months         |

  @Customer_Auto_E2E_Flow_PTMP
  Scenario Outline: Sceanrio "<Sceanrio ID>" I as a customer verify the New Subscription flow for Metro E Product Offerings "<Product_Offering>" through customer portal
    Given I logged in to the customer portal with "<username>" to verify "<Sceanrio_ID>"
    Then I should see the "OTP" page
    When I click the sign in button upon enter the OTP for customer portal login
    ...
    Examples: 
      ...
      | UAT_E2E_MetroE_TC1.6  | regspweekk37@gmail.com | Standard MetroE PTMP Fixed Rate                         | SG Connectivity | Network_MetroE_PTMP_GPON_Fixed        |             542116 |                 700 | NA                  | 12 Months         |
    #  | UAT_E2E_MetroE_TC1.8  | regspweekk37@gmail.com | Standard MetroE PTMP Burstable Rate                          | SG Connectivity | Network_MetroE_PTMP_GPON_Burstable    |             542116 |                 700 |                 900 | 12 Months         |
    #  | UAT_E2E_MetroE_TC1.xx | regspweekk37@gmail.com | Standard MetroE PTMP Fixed Rate with Protected Path     | SG Connectivity | Network_PTMP_Fixed_GPON_Protected     |             542116 |                 700 | NA                  | 12 Months         |
    #  | UAT_E2E_MetroE_TC1.11 | regspweekk37@gmail.com | Standard MetroE PTMP Burstable Rate with Protected Path | SG Connectivity | Network_PTMP_Burstable_GPON_Protected |             542116 |                 700 |                 900 | 12 Months         |

  @Customer_Auto_E2E_Flow_PTP
  Scenario Outline: Sceanrio "<Sceanrio ID>" I as a customer verify the New Subscription flow for Metro E Product Offerings "<Product_Offering>" through customer portal
    Given I logged in to the customer portal with "<username>" to verify "<Sceanrio_ID>"
    Then I should see the "OTP" page
    When I click the sign in button upon enter the OTP for customer portal login
    ...
    Then I should see the order confirmation page
    # And I verify the Reservation of resources at the Nokia - Order Management System
    When I select the appointments for GPON " NLT Wiring "," Installation " for site1,site2
    #Then I verify "Request for Service Date" calculated correctly
    When I confirm the order by selecting the "Existing Billing Account" along with billing contact details
    Then I should see the order submitted successfully
    When I click on the View Order button at the Thank you page
    ...
    Examples: 
      ...
      | UAT_E2E_MetroE_TC1.1  | regspweekk37@gmail.com | Standard MetroE PTP Burstable Rate                     | SG Connectivity | Network_PTP_GPON_Burstable           |        542116 |        542117 |                 700 |                 900 | 12 Months         |
     # | UAT_E2E_MetroE_TC1.2  | regspweekk37@gmail.com | Standard MetroE PTP Fixed Rate                         | SG Connectivity | Network_PTP_GPON_Fixed               |        542116 |        542117 |                 700 | NA                  | 12 Months         |
   #   | UAT_E2E_MetroE_TC1.xx | regspweekk37@gmail.com | Standard MetroE PTP Fixed Rate with Protected Path     | SG Connectivity | Network_PTP_GPON_Fixed_Protected     |        542116 |        542117 |                 700 | NA                  | 12 Months         |
    #  | UAT_E2E_MetroE_TC1.18 | regspweekk37@gmail.com | Standard MetroE PTP Burstable Rate with Protected Path | SG Connectivity | Network_PTP_GPON_Burstable_Protected |        542116 |        542117 |                 700 | NA                  | 12 Months         |
