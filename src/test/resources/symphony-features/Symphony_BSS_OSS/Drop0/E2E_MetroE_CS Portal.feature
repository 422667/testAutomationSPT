@MetroE_CS_Portal_Subscription_flow
Feature: 0.1 Customer - New Subscription Flow

  @Customer_E2E_Flow_ATA
  ...
  When I select the appointments for " Site Survey "," Wiring "," Installation "
   ...
   # And I verify the reserved appointments at the DWFM
    ...
    Examples: 
      ...
      #| UAT_E2E_MetroE_TC1.9  | dineshreddy.jetti@gmail.com | Standard MetroE ATA Fixed Rate                         | SG Connectivity | Network_ATA_Fixed           |             139951 | 24 Months         |
      | UAT_E2E_MetroE_TC1.xx | dineshreddy.jetti@gmail.com | Standard MetroE ATA Burstable Rate                     | SG Connectivity | Network_ATA_Burst           |             139951 | 24 Months         |
      | UAT_E2E_MetroE_TC1.10 | dineshreddy.jetti@gmail.com | Standard MetroE ATA Burstable Rate with Protected Path | SG Connectivity | Network_ATA_Burst_Protected |             139951 | 24 Months         |
      #| AT_E2E_MetroE_TC1.xx  | dineshreddy.jetti@gmail.com | Standard MetroE ATA Fixed Rate with Protected Path     | SG Connectivity | Network_ATA_Fixed_Protected |             139951 | 24 Months         |

  @Customer_E2E_Flow_PTMP
  Scenario Outline: Sceanrio "<Sceanrio ID>" I as a customer verify the New Subscription flow for Metro E Product Offerings "<Product_Offering>" through customer portal
    Given I logged in to the customer portal with "<username>"
    Then I should see the "OTP" page
    When I click the sign in button upon enter the OTP for customer portal login
 ...
 When I click on the View Order button at the Thank you page
  ...
  #  And I verify the billing details at the BRM
    ...
    Examples: 
      ...
      | UAT_E2E_MetroE_TC1.6  | dineshreddy.jetti@gmail.com | Standard MetroE PTMP Fixed Rate                              | SG Connectivity | Network_MetroE_PTMP_Fixed     |             139951 |                 700 | NA                  | 12 Months         |
      | UAT_E2E_MetroE_TC1.8  | dineshreddy.jetti@gmail.com | Standard MetroE PTMP Burstable Rate                          | SG Connectivity | Network_MetroE_PTMP_Burstable |             139951 |                 700 |                 900 | 12 Months         |
     # | UAT_E2E_MetroE_TC1.xx | dineshreddy.jetti@gmail.com | Standard MetroE PTMP Fixed Rate with Protected Path     | SG Connectivity | Network_PTMP_Fixed_Protected      |             139951 |                 700 | NA                  | 12 Months         |
      #| UAT_E2E_MetroE_TC1.11 | dineshreddy.jetti@gmail.com | Standard MetroE PTMP Burstable Rate with Protected Path | SG Connectivity | Network_PTMP_Fixed_Burstable      |             139951 |                 700 |                 900 | 12 Months         |

  @Customer_E2E_Flow_PTP
  Scenario Outline: Sceanrio "<Sceanrio ID>" I as a customer verify the New Subscription flow for Metro E Product Offerings "<Product_Offering>" through customer portal
    Given I logged in to the customer portal with "<username>"
   Then I should see the "OTP" page
   When I click the sign in button upon enter the OTP for customer portal login
    ...
    When I click on the Proceed to Quote button in the add to cart page
    Then I should see the Product configure page
    When I key in the product config details Network_Name as "<Network_Name>" ,postal_code_1 as "<postal_code_1>" ,postal_code_2 as "<postal_code_2>" and bandwidth details for CSportal
    #And I click on the Availbility Check button at the Product configure page
    When I click quote by key in contract_duration as "<Contract_duration>" for CSPortal
    #And I Verify the feasibility at the Nokia - Order Management System
    And I accept the quotation by placing the signature and verifying the terms and conditions
   ...
   # And I verify the Reservation of resources at the Nokia - Order Management System
    ...
    Examples: 
      ...
      | UAT_E2E_MetroE_TC1.1  | dineshreddy.jetti@gmail.com | Standard MetroE PTP Burstable Rate                     | SG Connectivity | Network_PTP  |        139951 |        139952 |                 700 |                 900 | 12 Months         |
      | UAT_E2E_MetroE_TC1.2  | dineshreddy.jetti@gmail.com | Standard MetroE PTP Fixed Rate                         | SG Connectivity | Network_PTP  |        139951 |        139952 |                 700 | NA                  | 12 Months         |
      | UAT_E2E_MetroE_TC1.xx | dineshreddy.jetti@gmail.com | Standard MetroE PTP Fixed Rate with Protected Path     | SG Connectivity | Network_PTP  |        139951 |        139952 |                 700 | NA                  | 12 Months         |
      | UAT_E2E_MetroE_TC1.18 | dineshreddy.jetti@gmail.com | Standard MetroE PTP Burstable Rate with Protected Path | SG Connectivity | Network_PTP  |        139951 |        139952 |                 700 | NA                  | 12 Months         |
