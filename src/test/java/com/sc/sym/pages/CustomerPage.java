...
public class CustomerPage {
	 WebDriver driver;
	    ...
	    { 
	    	...
	    	wpm.waitTillVisible(Customer);
	    	Customer.click();
	    	Reporter.addScreenCaptureFromPath(wpm.getScreenshot());
	    	create.click();
	    	wpm.waitTillVisible(UEN);
	    	UEN.sendKeys(rm.UEN,Keys.TAB);
	    	driver.findElement(By.xpath("/html/body/app-root/div/crmx-horizontal-layout/div[2]/div[2]/section/app-customer/cust-add-page/crmx-card/div/div[2]/div/div/crmx-card[1]/div/div[2]/div/div/organization-add/formly-form/formly-field[2]/formly-group/formly-field[1]/app-formly-lookup/app-lookup/div/div/select")).click();
	    	driver.findElement(By.xpath("//option[text()='Public Limited Company']")).click();
	    	//Select drpdwn = new Select(driver.findElement(By.xpath("//select[@class='form-control ng-pristine ng-valid ng-star-inserted ng-touched']")));
	    	...
	    	wpm.waitTillVisible(Market_Segment);
	    	Market_Segment.click();
	    	//All_Segment.click();
	    	Reporter.addScreenCaptureFromPath(wpm.getScreenshot());
	    	Add_contact.click();
	    	Reporter.addScreenCaptureFromPath(wpm.getScreenshot());
	    	...
	    	driver.findElement(By.xpath("//label[text()='"+rm.contact_Role.replaceAll("_"," ")+"']")).click();
	    	First_name.click();
